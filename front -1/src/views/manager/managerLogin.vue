        ...
        >
          ...
          <div class="input-field">
            ...
            <el-form-item prop="administratorId">
              <el-input
                v-model="loginForm.administratorId"
...
const loginApi = "http://121.40.197.3:10010/administrator/login"
// 登录规则
const loginRules = {
  administratorId: [
    ...
    if (valid) {
      ...
      try {
        ...
        const response = await axios.post(loginApi, {
          administratorId: parseInt(loginForm.administratorId),
        ...
        if (response.status === 200 && response.data) {
          ...
          // 从嵌套结构中获取管理员信息和JWT
          const { administrator, jwt } = response.data;
          
          // 分别存储
          localStorage.setItem('jwt', jwt);
          localStorage.setItem('adminInfo', JSON.stringify(administrator));
          
          console.log("管理员信息", administrator);
        ...
        ElMessage.error("登录失败，请检查管理员ID和密码");
